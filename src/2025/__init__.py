...
pattern = r'^(?!.*(?:x([2-9]\d*(\.\d*)?)|([2-9]\d*(\.\d*)?)x|x1\.[1-9]\d*|1\.[1-9]\d*x)).*(?:x(0(\.\d*)?|1(\.0*)?)|(0(\.\d*)?|1(\.0*)?)x).*$|^(?!.*(?:x([2-9]\d*(\.\d*)?)|([2-9]\d*(\.\d*)?)x|x1\.[1-9]\d*|1\.[1-9]\d*x))[^x]*$'
test_strings = ["🇸🇬 [开发测试]0.2x|GloB￫新加坡A", "🇮🇳 1.0x|GX5G集群￫印度", "🇭🇰 [新]2.0x|电信测试￫香港", "x1.0", "0.6x",
                "0.5x", "2.5x", "2.5x", "5.0x", "10.0x", "10x",
                "🇭🇰 [新][企业专线CM]10x￫香港", "5x", "🇬🇧英国高级-1 x5"]
